...
**Update at 02 Aug 2022:** we revised the code to support directly predicting result for `tatqa_and_hqa_dataset_A.json`. Try running the code with our trained checkpoint and make a first submission ~
