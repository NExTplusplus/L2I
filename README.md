...
**Update at 02 Aug 2022:** we revised the code to support directly predicting result for `tatqa_and_hqa_dataset_A.json`. Get the code running with the our trained checkpoint and make a first submission ~
